...
call npx electron-builder --win portable --prepackaged dist\win-unpacked --config.win.target=portable --config.win.artifactName="Scripture Map Labeler Portable ${version}.${ext}" --debug
