...
contextBridge.exposeInMainWorld('electronAPI', {
  loadTermRenderings: (folder, saveToDemo) => ipcRenderer.invoke('load-term-renderings', folder, saveToDemo),
  saveTermRenderings: (folder, saveToDemo, data) => ipcRenderer.invoke('save-term-renderings', folder, saveToDemo, data),
